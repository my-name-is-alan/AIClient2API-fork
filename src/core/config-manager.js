...
export async function initializeConfig(args = process.argv.slice(2), configFilePath = 'configs/config.json') {
    ...
    const cliArgDefs = [
        ...
        { flag: '--openai-api-key',       configKey: 'OPENAI_API_KEY',         type: 'string' },
        { flag: '--openai-base-url',      configKey: 'OPENAI_BASE_URL',        type: 'string' },
        { flag: '--claude-api-key',       configKey: 'CLAUDE_API_KEY',         type: 'string' },
        { flag: '--claude-base-url',      configKey: 'CLAUDE_BASE_URL',        type: 'string' },
        { flag: '--gemini-oauth-creds-base64', configKey: 'GEMINI_OAUTH_CREDS_BASE64', type: 'string' },
        { flag: '--gemini-oauth-creds-file', configKey: 'GEMINI_OAUTH_CREDS_FILE_PATH', type: 'string' },
        { flag: '--kiro-oauth-creds-base64', configKey: 'KIRO_OAUTH_CREDS_BASE64', type: 'string' },
        { flag: '--kiro-oauth-creds-file', configKey: 'KIRO_OAUTH_CREDS_FILE_PATH', type: 'string' },
        { flag: '--qwen-oauth-creds-file', configKey: 'QWEN_OAUTH_CREDS_FILE_PATH', type: 'string' },
        { flag: '--project-id',           configKey: 'PROJECT_ID',             type: 'string' },
