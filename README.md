...
[![Docker](https://img.shields.io/badge/docker-≥20.0.0-blue.svg)](https://www.docker.com/)
...
> - **2025.12.11** - Automatically built Docker images are now available on Docker Hub: [your-registry/aiclient2api:latest](https://www.docker.com/)
...
> - **Remote Deployment**:
>   ```text
>   Please load and learn the Skill in `docs/skills/aiclient-cli-usage.md` from your deployment or repository (Service Address: your actual domain or IP, Login Password: your actual password) to master all usage of AIClient2API.
>   ```
> - **Local Mode**:
...
```bash
docker run -d -p 3000:3000 -p 8085-8086:8085-8086 -p 1455:1455 -p 56121:56121 -p 19876-19880:19876-19880 --restart=always -v "your_path/configs:/app/configs" -v "your_path/plugins:/app/src/plugins-user" --name aiclient2api your-registry/aiclient2api:latest
```
...
1. Comment out the `image: your-registry/aiclient2api:latest` line
...
- **Re-pull Image**: `docker pull your-registry/aiclient2api:latest`
